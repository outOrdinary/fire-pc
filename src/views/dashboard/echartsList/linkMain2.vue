<template>
  <div style="display: flex;flex-direction: column;justify-content: center;align-items: center;">
    <div id="logLinkMain2" ref="chartLogLink" style="width:100%; height:calc(100vh - 450px);" />
    <div class="pieTitle">
...
export default {
  ...
  methods: {
    ...
    option (val, time, title) {
      var data = {
        color: ['#eb0010', '#1e2084', '#b73630', '#2c4353', '#d87a80',
    ...
    initChart (data) {
      this.chart = this.$echarts.init(document.getElementById('logLinkMain2'))
